...
<body>
	...
	<% if(session.getAttribute("loginId") == null){ %>
		<div>
			<form method="post" action="<%=request.getContextPath()%>/ex04_session/login_practice/02_login.jsp">
	...
	<script>
		$('#btn_logout').on('click', function(){
			location.href = '<%=request.getContextPath()%>/ex04_session/login_practice/03_logout.jsp';
		})
	</script>
</body>
</html>