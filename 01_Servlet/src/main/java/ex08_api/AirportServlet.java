...
public class AirportServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 사이트의 요청 주소  (필수 2개 + 요청 파라미터 3개)
		String apiURL = "http://openapi.airport.co.kr/service/rest/FlightScheduleList/getIflightScheduleList";
		apiURL += "?serviceKey=" + URLEncoder.encode(serviceKey, "UTF-8");  // 필수
		apiURL += "&pageNo=" + URLEncoder.encode("1", "UTF-8");				// 필수 
		...
		// xml 분석하기 위해 -> 분석 결과 item을 찾아서 태그 뽑아내면 되겠다.
